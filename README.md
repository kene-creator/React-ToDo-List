...
> This is a demo todo list appwith react.js
...
- To clone the project on your machine: Type `git clone https://github.com/kene-creator/React-ToDo-List.git`.
...
Feel free to check the [issues page](https://github.com/kene-creator/React-ToDo-List.git/issues).
